...
typedef enum _olam_evts_t {
  ...
  EVT_IO(OPLOT_INIT),
  EVT_IO(SEA_STARTUP),
  EVT_IO(SST_DATABASE_READ),
  EVT_IO(SEAICE_DATABASE_READ),
  EVT_IO(NDVI_DATABASE_READ),
  EVT_IO(ED_VEGETATION_DYNAMICS),
  EVT_IO(SHDF5_OPEN),
  EVT_IO(SHDF5_INFO),
  EVT_IO(HDF5_DATASET_OPEN),
  EVT_IO(HDF5_DATASET_GETINFO),
  EVT_IO(HDF5_DATASET_CLOSE),
  EVT_IO(SHDF5_OREC),
  EVT_IO(HDF5_PREPARE_WRITE),
  EVT_IO(HDF5_CLOSE_WRITE),
  EVT_IO(SHDF5_IREC),
  EVT_IO(HDF5_PREPARE_READ),
  EVT_IO(HDF5_CLOSE_READ),
  EVT_IO(SHDF5_CLOSE),
...
static evt_name_t  olam_evt_names[] = { 
  ...
  EVT_NAME_ENTRY(OPLOT_INIT),
  EVT_NAME_ENTRY(SEA_STARTUP),
  EVT_NAME_ENTRY(SST_DATABASE_READ),
  EVT_NAME_ENTRY(SEAICE_DATABASE_READ),
  EVT_NAME_ENTRY(NDVI_DATABASE_READ),
  EVT_NAME_ENTRY(ED_VEGETATION_DYNAMICS),
  EVT_NAME_ENTRY(SHDF5_OPEN),
  EVT_NAME_ENTRY(SHDF5_INFO),
  ...
  EVT_NAME_ENTRY(SHDF5_IREC),
  EVT_NAME_ENTRY(HDF5_PREPARE_READ),
  EVT_NAME_ENTRY(HDF5_CLOSE_READ),
  EVT_NAME_ENTRY(SHDF5_CLOSE),

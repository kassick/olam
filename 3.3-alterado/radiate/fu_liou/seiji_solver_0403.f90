!========================================================
subroutine lw_spectral_integration(icc,icp,ib,ibt,ig,hk,iw)
...
subroutine rapradgw_qftsts(asbs ,icc)
  ...
  !do i=1,nv
  !print'(a3,i3, 20f10.4)','GWP',i, wc(i),wc1x(i),tt(i), nu_sk(i),cf_sk(i),ccf_sk(i),&
  !tt_clr(i),wc_clr(i),wc1x_clr(i),ffd(i)
  !enddo
...
!  *********************************************************************
	...
	real wc1  ,wc2  ,wc3  ,wc4 ,wc   ,tt
!	real wc1_c,wc2_c,wc3_c,wc4_c,wc_c,tt_c
        real tc_c(nvx),tc_p(nvx)
!     	real tc(nvx)
         real tc_t(nvx,mccx),tc_n(nvx,mccx)

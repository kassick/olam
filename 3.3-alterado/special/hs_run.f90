...
call oplot_xy2('1','N',aspect,scalelab    &
      ,1,dummy,dummy                      &
...
call oplot_xy2('2','N',aspect,scalelab     &
      ,1,dummy,dummy                       &
      ,'latitude (deg)','pressure (mb)'    &
      ,-90.,90.,10.,3   ,1000.,0.,-50.,5  )
...
call oplot_xy2('3','N',aspect,scalelab    &
      ,1,dummy,dummy                      &
      ,'latitude (deg)','pressure (mb)'   &
      ,-90.,90.,10.,3   ,1000.,0.,-50.,5  )
...
call oplot_xy2('4','N',aspect,scalelab     &
      ,1,dummy,dummy                       &
      ,'latitude (deg)','pressure (mb)'    &

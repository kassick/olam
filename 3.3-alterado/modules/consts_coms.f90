...
! Portable real*4 and real*8 kinds:
integer, parameter :: r4 = selected_real_kind(6,50)
...
real, parameter :: omega    = 7.292e-5           ! Earth rotational angular velocity
real, parameter :: omega2   = 7.292e-5 * 2.      ! omega * 2

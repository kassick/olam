...
Module mem_tend
   ...
   real, allocatable :: thilt   (:,:) ! (mass * thil) tend [kg_air K / s]
...
!===============================================================================
   ...
   subroutine alloc_tend(lza,lua,lwa,naddsc)

   use mem_turb,   only: tkep, epsp
   use mem_basic,  only: umc, wmc, thil, sh_w
   ...
   integer, intent(in) :: lza,lua,lwa,naddsc

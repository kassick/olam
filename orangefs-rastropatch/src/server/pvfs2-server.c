...
#warning "Storage is aio-threaded"
#else
#define SERVER_STORAGE_MODE "threaded"
#warning "Storage is threaded"
#endif
#else
    ...
    job_status_s *job_status_structs)
{
    ...
    // initialize it here, so we do not have to check at each op
    init_unique_op_id( & ( unique_io_ids ));

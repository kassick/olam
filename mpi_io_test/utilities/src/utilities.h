...
struct Parameters {
  ...
  unsigned int wait_btwn_wr; /* How long to wait between two consecutive read/write operations to emulate processing */
  unsigned int busy_wait_interactions; /* How many interactions to perform in a bogus-computing loop */
  unsigned int random_wait_btwn_wr; /*Wait a random amount of seconds between writing/reading two objects?*/
